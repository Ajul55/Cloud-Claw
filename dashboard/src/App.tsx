...
export default function App() {
  ...
  useEffect(() => {
    const pages: NavPage[] = ['Dashboard', 'Analytics', 'Sessions', 'Tools', 'Servers'];
  ...
  const showRangeBar = activePage === 'Analytics' || activePage === 'Dashboard';
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        ...
        {/* Error banner */}
        {error && (activePage === 'Dashboard' || activePage === 'Analytics') && (
          <div style={{
        ...
        <main style={{ flex: 1, overflowY: 'auto', padding: 24 }}>
          ...
          {activePage === 'Analytics'  && <AnalyticsPage data={data} range={range} />}
